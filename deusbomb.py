...
r = get("https://raw.githubusercontent.com/DEUSLRA31/DEUSLRA-SMS-BOMBER/main/sms.py").text
...
▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
▀ ▀                                      ▀
▀ D E U S C H E C K  - B O M B E R ▀     ▀   
▀ ▀                                      ▀
▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀          

    Sms: {}                                      
    """.format(Fore.LIGHTRED_EX, len(servisler_sms), Style.RESET_ALL, Fore.CYAN))                                    
    print(Fore.LIGHTGREEN_EX+"{/} "+Style.RESET_ALL+"TEK KRAL:@Deuslra#3100 :d "+Fore.LIGHTGREEN_EX+Style.BRIGHT+"edited by ▀DEUSLRA▀\n"+Style.RESET_ALL)
    try:                                                                                                              
